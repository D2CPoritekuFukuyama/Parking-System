...
string NplateMatch::Matching(){
    ...
    Ptr<IplImage> src_img1 = cvLoadImage("image/Nplate-down.jpg", CV_LOAD_IMAGE_GRAYSCALE); //探索対象画像
    Ptr<IplImage> category_img = cvLoadImage("image/Nplate-cate.jpg", CV_LOAD_IMAGE_GRAYSCALE); //探索対象画像
